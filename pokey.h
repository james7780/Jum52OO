...
public:
	CPOKEY::CPOKEY();
	void Initialise(uint32 freq17, uint16 playbackFreq, uint8 numPokeys);
	void Update(uint16 addr, uint8 val, uint8 chip, uint8 gain);
	void Process(register unsigned char *buffer, register uint16 n);
	//void Process2(register unsigned char *buffer, register uint16 n);
